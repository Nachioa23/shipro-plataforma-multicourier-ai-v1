...
## DEUDA 180 — Mercado Envíos Flex (MEF): integración con Mercado Libre (registrada 2026-09-13, lidera Chat D, scope grande, **Fase 1 (núcleo) COMPLETA local 2026-09-14** — steps 1+2+3+4 hechos, commits `b53426d`+`18d33c3`+`6ea745b`+`cbc96da`+`cf49e93`+`e0634e7`; follow-ups menores documentados; step 5 (adapter) + Fase 2 (worker) por delante bajo Chat D; ningún deploy prod aún, gated manual)
