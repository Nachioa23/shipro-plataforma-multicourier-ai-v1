/*
  ...
  - Added the required column `tokenVoto` to the `EncuestaNPSEmpresa` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_EncuestaNPSEmpresa" ("calidadSoporte", "categoria", "empresaId", "fechaEnvio", "fechaVoto", "fortaleza", "id", "periodo", "satisfaccionPlataforma", "score", "sugerencia", "usuarioId") SELECT "calidadSoporte", "categoria", "empresaId", "fechaEnvio", "fechaVoto", "fortaleza", "id", "periodo", "satisfaccionPlataforma", "score", "sugerencia", "usuarioId" FROM "EncuestaNPSEmpresa";
